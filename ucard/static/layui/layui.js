      ...
      ((t =
        h.currentScript && "SCRIPT" === h.currentScript.tagName.toUpperCase()
          ...
          : (function () {
              for (
                var t,
                  e = h.getElementsByTagName("script"),
                  n = e.length - 1,
                  o = n;
                0 < o;
                o--
    ...
    n =
      ...
      (p.touchSwipe = function (t, e) {
        ...
        c &&
          ...
          c.__lay_touchswipe_cb_ &&
            c.removeEventListener("touchstart", c.__lay_touchswipe_cb_),
            ...
            input: function (e) {
              ...
              a.find("input[lay-affix],textarea[lay-affix]").each(function () {
                var r = _(this),
                  ...
                  d = function (e, t) {
                    (e = _(e))[0] &&
                      e[_.trim(t) ? "removeClass" : "addClass"](j);
                  },
                  n = function (i) {
                    i = _.extend(
                      {},
                ...
                y = function (n, e, t, i, u, a) {
                  ...
                  t ||
                    ...
                    (c = function () {
                      ...
                      var e =
                          n.offset().top + n.outerHeight() + 5 - S.scrollTop(),
                        t = g.outerHeight(),
                        i = g.children("dd");
                      (k = y[0].selectedIndex),
                    ...
                    (h = function (e) {
                      v.parent().removeClass(C + "ed " + C + "up"),
                        ...
                        a &&
                          (n.detach(),
                          _(window).off("resize.lay_select_resize")),
                        e ||
                          p(m.val(), function (e) {
            ...
            checkbox: function (e) {
              ...
              e.each(function (e, t) {
                var i = _(this),
                  ...
                  n = A.escape(
                    _.trim(t.title || (t.title = i.attr("lay-text") || ""))
                  ),
                  l = this.disabled,
                  r = c[a] || c.checkbox,
                  s = i.next("." + r[0]),
                ...
                d &&
                  ...
                  t.checked ||
                    p.call(t, "lay-form-sync-indeterminate", t.indeterminate));
                l = _(
                  [
            ...
            radio: function (e) {
              ...
              e.each(function (e, t) {
                var i = _(this),
                  ...
                  l = i.attr("lay-skin");
                if ("string" == typeof i.attr("lay-ignore")) return i.show();
                d && p.call(t, "lay-form-sync-checked", t.checked),
                  a[0] && a.remove();
            ...
            w.docEvent ||
              z
                ...
                .on("mouseup", function (e) {
                  var t, a, i, l, n;
                  w.eventMoveElem &&
                    ((i = (t = w.eventMoveElem).closest("." + D).attr(N)),
                    (a = C(i))) &&
                    ((i = t.data("key")),
                    (l = a.col(i)),
            ...
            c.layBody
              ...
              .on("mouseleave", "tr", function () {
                var e = f(this),
                  t = e.index();
                e.data("off") ||
                  c.layBody.find("tr:eq(" + t + ")").removeClass(_);
              })
    ...
    u =
      ...
      (B.removeNode = function (e, t, a) {
        ...
        if (n) {
          var i,
            ...
            d =
              (n.updateCheckStatus(f),
              n.treeToFlat([t], t[d.customName.pid], t[p])),
            t =
      ...
      (a.prototype.updateParentCheckStatus = function (a, n) {
        ...
        return (
          ...
          d.push(A.extend({}, a)),
          (d = a[p]
            ? d.concat(this.updateParentCheckStatus(P.cache[e][a[p]], n))
            : d)
        );
      }),
      function (e, t, a) {
            ...
            Date.now() - a.timeStart <= 200 ||
              ...
              l.each(function (e) {
                var a = u(this).children("i"),
                  ...
                  e = i - e == 0.5;
                t
                  ? (a.addClass(f).removeClass(v),
                    n.half && e && a.addClass(o).removeClass(f))
